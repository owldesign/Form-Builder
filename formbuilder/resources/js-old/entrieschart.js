...
Craft.FormBuilder.EntriesIndex = Craft.BaseElementIndex.extend({
    getViewClass: function(mode) {
        switch (mode) {
            case 'table':
                return Craft.FormBuilder.EntriesTableView;
            default:
...
Craft.FormBuilder.EntriesTableView = Craft.TableElementIndexView.extend({
    ...
    {
        return Craft.FormBuilder.EntriesTableView.getStorage(this.elementIndex._namespace, key);
    },

    setStorage: function(key, value)
    {
        Craft.FormBuilder.EntriesTableView.setStorage(this.elementIndex._namespace, key, value);
    },
    ...
    {
        if (this.setStartDate(Craft.FormBuilder.EntriesTableView.getDateFromDatepickerInstance(this.startDatepicker)))
        {
            this.loadReport();
        }
    },
    ...
    {
        if (this.setEndDate(Craft.FormBuilder.EntriesTableView.getDateFromDatepickerInstance(this.endDatepicker)))
        {
            this.loadReport();
        }
    },
    ...
    loadReport: function()
    {
        ...
        requestData.startDate = Craft.FormBuilder.EntriesTableView.getDateValue(this.startDate);
        requestData.endDate = Craft.FormBuilder.EntriesTableView.getDateValue(this.endDate);
...
},
{
    ...
    {
        if (Craft.FormBuilder.EntriesTableView.storage[namespace] && Craft.FormBuilder.EntriesTableView.storage[namespace][key])
        {
            return Craft.FormBuilder.EntriesTableView.storage[namespace][key];
        }
    ...
    {
        if (typeof Craft.FormBuilder.EntriesTableView.storage[namespace] == typeof undefined)
        {
            Craft.FormBuilder.EntriesTableView.storage[namespace] = {};
        }

        Craft.FormBuilder.EntriesTableView.storage[namespace][key] = value;
    },
