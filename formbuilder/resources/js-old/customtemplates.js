    ...
    Editor = Garnish.Base.extend({
      ...
      setFormData: function(fieldId, template) {
        ...
        if (hasLabel) {
          ...
          $field.append("<div class=\"email-result\">" + template + "</div>");
          return $field.find('.email-result').prepend(svg);
        } else {
